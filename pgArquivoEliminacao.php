...
<body>
    <div class="container-fluid">
        ...
        <?php
        $busca_pasta = "SELECT `ID`, `SETOR`, `ANO`, `ASSUNTO`, `CODIGO`, `CORRENTE`, `INTERMEDIARIO`, `DESTFINAL`, `NCAIXA`, `ESTANTE` FROM `caixa` WHERE Tipo = 'ELIMINAÇÃO'  order by ESTANTE, NCAIXA";
