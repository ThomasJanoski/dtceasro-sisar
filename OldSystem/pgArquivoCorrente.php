...
<body>
    <div class="container-fluid">
        ...
        <?php
        $busca_pasta = "SELECT `ID`, `SETOR`, `ANO`, `ASSUNTO`, `CODIGO`, `CORRENTE`, `INTERMEDIARIO`, `DESTFINAL`, `NCAIXA`, `ESTANTE` FROM `caixa` WHERE Tipo = 'Corrente'  order by NCAIXA, ESTANTE";
        ...
        echo "<div class='col-12 mb-3'><h3 class='text-center  text-white'>Estante: $ESTANTE</h3></div>";
            ...
            $anoFinal = (int) substr($CORRENTE, strpos($CORRENTE, '-') + 1);
