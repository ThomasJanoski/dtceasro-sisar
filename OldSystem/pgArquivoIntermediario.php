...
<body>
    <div class="container-fluid">
        ...
        <?php
        $busca_pasta = "SELECT `ID`, `SETOR`, `ANO`, `ASSUNTO`, `CODIGO`, `CORRENTE`, `INTERMEDIARIO`, `DESTFINAL`, `NCAIXA`, `ESTANTE` FROM `caixa` WHERE Tipo = 'INTERMEDIARIO'  order by ESTANTE, NCAIXA";
	...
	$stringComparar = $INTERMEDIARIO;
	if (!strpos($stringComparar, "-")) {
                 $stringComparar .= "-" . $stringComparar;
            }
            // Extrai o ano final do intervalo de $CORRENTE
            $anoFinal = (int) substr($stringComparar, strpos($stringComparar, '-') + 1);
            ...
            if ($anoFinal >= $anoAtual) {
               ...
               echo "<p class='card-text assunto'>Assunto: $ASSUNTO</p>";
                ...
                echo '</div>';
                echo '</div>';
            } elseif ($anoFinal < $anoAtual && $DESTFINAL == "ELIMINAÇÃO") {
                
                echo '<div class="col-sm-2.5 mb-4" id="sexo">';
                echo "<div class='card text-white bg-danger'>";
                echo "<div class='card-header'>Setor: $SETOR</div>";
                echo '<div class="card-body">';
                echo "<h5 class='card-title'>Ano: $ANO</h5>";
            ...
            elseif ($anoFinal < $anoAtual && $DESTFINAL == "PERMANENTE"){
                echo '<div class="col-sm-2.5 mb-4" id="sexo">';
